#pragma once
#include "FST.h"
#define FST_INTEGER  FST::NODE(1, FST::RELATION('i', 1)), \
...
#define FST_STRING  FST::NODE(1, FST::RELATION('s', 1)), \
...
#define FST_FUNCTION  FST::NODE(1, FST::RELATION('f', 1)), \
...
#define FST_DECLARE  FST::NODE(1, FST::RELATION('d', 1)), \
...
#define FST_RETURN  FST::NODE(1, FST::RELATION('r', 1)), \
FST::NODE(1, FST::RELATION('e', 2)),\
FST::NODE(1, FST::RELATION('t', 3)), \
...
#define FST_PRINT  FST::NODE(1, FST::RELATION('p', 1)), \
...
#define FST_MAIN  FST::NODE(1, FST::RELATION('m', 1)), \
...
#define FST_OCT \
	...
	FST::NODE(16, FST::RELATION('0', 2),FST::RELATION('1', 2), FST::RELATION('2', 2), FST::RELATION('3', 2),FST::RELATION('4', 2), FST::RELATION('5', 2),FST::RELATION('6', 2), FST::RELATION('7', 2),\
...
#define FST_BIN  \
	...
	FST::NODE(18, FST::RELATION('0', 2), FST::RELATION('1', 2),\
				  FST::RELATION('0', 3), FST::RELATION('1', 3),\
				  FST::RELATION('0', 4), FST::RELATION('1', 4),\
				  FST::RELATION('0', 5), FST::RELATION('1', 5),\
				  FST::RELATION('0', 6), FST::RELATION('1', 6),\
				  FST::RELATION('0', 7), FST::RELATION('1', 7),\
				  FST::RELATION('0', 8), FST::RELATION('1', 8),\
				  FST::RELATION('0', 9), FST::RELATION('1', 9)),\
	FST::NODE()
...
#define FST_LEFT_BRACE 	\
	FST::NODE(1, FST::RELATION('{', 1)),\
	FST::NODE()

#define FST_RIGHT_BRACE	\
	FST::NODE(1, FST::RELATION('}', 1)),\
	FST::NODE()

#define FST_LEFT_BRACKET	\
	FST::NODE(1, FST::RELATION('(', 1)),\
	FST::NODE()

#define FST_RIGHT_BRACKET	\
	FST::NODE(1, FST::RELATION(')', 1)),\
	FST::NODE()

#define FST_ASSIGNMENT	\
	FST::NODE(1, FST::RELATION('=', 1)),\
	FST::NODE()
#define FST_EQUAL	\
	FST::NODE(1, FST::RELATION('=', 1)),\
