...
namespace MFST
{
	...
	MfstState::MfstState(short pposition, MyStack<short> pst, short pnrulechain)
	{
	...
	MfstState::MfstState(short pposition, MyStack<short> pst, short pnrule, short pnrulechain)
	{
		lenta_position = pposition;
		st = pst;
		nrule = pnrule;
	...
	Mfst::Mfst(Lan::LAN plex, GRB::Greibach pgrebach)
	{
		grebach = pgrebach;
		lex = plex.lexTable;
